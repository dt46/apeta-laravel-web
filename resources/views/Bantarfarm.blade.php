...
<body>
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li>/</li>
                    <li><span>Partner products</span></li>
                                    ...
                                    <body>
                                        ...
                                        <div class="farm-profile">
                                            ...
                                            <div class="profile-info">
                                                <div class="profile-name">Bantar Jati Farm</div>
                                                <div class="profile-description">
                                                    Peternakan Bantar Jati Farm adalah sebuah usaha peternakan yang mengkhususkan diri dalam penyediaan ayam, kambing,
                                                    dan telur berkualitas tinggi. Dengan fokus pada praktik peternakan yang berkelanjutan dan etis,
                                                    Bantar Jati Farm memberikan perhatian khusus terhadap kesejahteraan hewan dan kualitas produk.
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__content">
                                                    ...
                                                    <div class="product-card__right">
                                                        <a href="{{ route('Bantarfarm') }}">Bantar Jati Farm</a>
                                                    </div>
                                                    <!-- /.product-card__right -->
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="product-card">
                                                <div class="product-card__image">
                                                    <img src="{{asset('assets/images/products/product-2-2.png')}}" alt="">
                                                    <div class="product-card__image-content">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="product-card">
                                                <div class="product-card__image">
                                                    <img src="{{asset('assets/images/products/product-2-4.png')}}" alt="">
                                                    <div class="product-card__image-content">
                                                        <a href="{{ route('product-details') }}"><i class="organik-icon-shopping-cart"></i></a>
                                                    </div><!-- /.product-card__image-content -->
                                                </div><!-- /.product-card__image -->
                                                <div class="product-card__content">
                                                    ...
                                                    <div class="product-card__right">
                                                        <p><a href="{{ route('Bantarfarm') }}">Bantar Jati Farm</a></p>
                                                    </div>
                                                    </div><!-- /.product-card__right -->
                                                </div><!-- /.product-card__content -->
                                            </div><!-- /.product-card -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2">
                        <div class="footer-widget">
                            ...
                            <ul class="list-unstyled footer-widget__links">
                                ...
                                <li>
                                    <a href="{{ route('contact') }}">Bantar Jati Farm</a>
                                </li>
                                <li>
            ...
            <div class="mini-cart__item">
                ...
                <div class="mini-cart__item-content">
                    <div class="mini-cart__item-top">
                        <h3><a href="{{ route('productdetails
    ...
    <!-- template js -->
    <!-- <script src="resources/js/organik.js"></script> -->
