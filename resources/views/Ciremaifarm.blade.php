...
@section('title', 'Organik ciremaifarm')
@section('content')
<body>
    <div class="preloader">
                                    ...
                                    <body>
                                        ...
                                        <div class="farm-profile">
                                            ...
                                            <div class="profile-info">
                                                <div class="profile-name">Ciremai Farm</div>
                                                <div class="profile-description">
                                                    Peternakan Ciremai Farm adalah sebuah usaha peternakan yang mengkhususkan diri dalam penyediaan ayam, kambing,
                                                    dan telur berkualitas tinggi. Dengan fokus pada praktik peternakan yang berkelanjutan dan etis,
                                                    Ciremai Farm memberikan perhatian khusus terhadap kesejahteraan hewan dan kualitas produk.
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__content">
                                                    ...
                                                    <div class="product-card__right">
                                                        <a href="{{ route ('Ciremaifarm') }}">Ciremai Farm</a>
                                                    </div>
                                                    <!-- /.product-card__right -->
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__content">
                                                    ...
                                                    <div class="product-card__right">
                                                        <p><a href="{{ route ('Ciremaifarm') }}">Ciremai Farm</a></p>
                                                    </div>
                                                    </div><!-- /.product-card__right -->
                                                </div><!-- /.product-card__content -->
                                            </div><!-- /.product-card -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2">
                        <div class="footer-widget">
                            ...
                            <ul class="list-unstyled footer-widget__links">
                                ...
                                <li>
                                    <a href="{{ route ('contact') }}">Ciremai Farm</a>
                                </li>
                                <li>
