        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $dataProduk = json_decode($response);
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="ms-1 text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Produk</div>
                                            <div class="ms-1 h5 mb-0 font-weight-bold text-gray-800"><?php echo count($dataProduk); ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="me-3 fas fa-vial fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
